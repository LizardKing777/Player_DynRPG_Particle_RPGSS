...
Game_Message::ParseParamResult Game_Message::ParseStringVariable(const char* iter, const char* end, uint32_t escape_char, bool skip_prefix, int max_recursion) { //STRVARS
