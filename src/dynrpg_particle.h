...
//      bool Invoke(std::string_view, dyn_arg_list args, bool& do_yield, Game_Interpreter* interpreter) override;
        bool Invoke(std::string_view, dyn_arg_list args, bool& do_yield, Game_Interpreter* interpreter);
